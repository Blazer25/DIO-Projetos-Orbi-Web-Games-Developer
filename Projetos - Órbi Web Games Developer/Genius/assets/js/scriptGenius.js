...
const vermelho = document.querySelector(".vermelho") // representado pelo número 0
const azul = document.querySelector(".azul") // representado pelo número 1
const amarelo = document.querySelector(".amarelo") // representado pelo número 2
const verde = document.querySelector(".verde") // representado pelo número 3
